...
class ProductsListLocators:
    ...
    CARD_PRODUCT_SIZE = (By.XPATH, '(//li[@class="item product product-item"]/..//div[@option-tooltip-value="M"])[{}]')
    CARD_PRODUCT_COLOR = (
        By.XPATH, '(//li[@class="item product product-item"]//div[@attribute-code="color"]//div[@index="0"])[{}]')
    ADD_TO_CART = (By.XPATH, '(//button//span[text()="Add to Cart"])[{}]')
    SELECTED_NAME_PRODUCT = (
        By.XPATH, '(//li[@class="item product product-item"]//strong[@class="product name product-item-name"]//a)[{}]')
